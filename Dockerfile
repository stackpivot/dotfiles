...
#   docker build -t dotfiles /home/${USER}/src/github.com/stackpivot/dotfiles
...
#   cd /home/${USER}/src/github.com/stackpivot/dotfiles
#   make install
#   make init
...
RUN mkdir -p /home/${USERNAME}/src/github.com/stackpivot && cd /home/${USERNAME}/src/github.com/stackpivot && git clone git://github.com/stackpivot/dotfiles
